package rideshare.view;

import rideshare.model.*;

import static rideshare.Utils.FORMAT;
import static utils.LogHandler.LOGGER;
import static rideshare.view.StyleUtils.*;

import rideshare.model.interfaces.ElementsOnMap;
...
//                    System.out.println("======================style paths======================");
    ...
    private void sleep() {
        ...
        clock.setAttribute("ui.label", FORMAT(simulatorStartDate));
    ...
    private Node drawNode(rideshare.model.Node node){
...
//        System.out.println(rideshare.view.getCamera().transformPxToGu(e.getX() ,e.getY()));
    }
