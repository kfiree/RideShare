            ...
            <View style={styles.container}>
                ...
                <View style={styles.popup}>
                    <View style={styles.rowBox}>
                        <Text style={styles.titlePopup}>ההרשמה בוצעה בהצלחה!</Text>
                    </View>
                    <View style={styles.rowBox}>
                        <Text style={styles.textPopup}>הפרטים שלך הועברו לבדיקה,</Text>
                    </View>
                    <View style={styles.rowBox}>
                        <Text style={styles.textPopup}>לאחר אישור הפרטים, נעדכן</Text>
                    </View>
                    <View style={styles.rowBox}>
                        <Text style={styles.textPopup}>אותך באסמס(:</Text>
                    </View>
