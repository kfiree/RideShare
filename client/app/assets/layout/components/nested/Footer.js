...
const Footer = () => {
    const { sendNotificationToClient, userData, setUserData, loadingPopup, setLoadingPopup, isSignedIn, setIsSignedIn, search, setSearch } = useContext(Context)
                    ...
                    <View style={[styles.boxSize, { backgroundColor: "white" }]} >
                        <View style={styles.imageIcon}>
                            <Image
                                ...
                                source={require('./../../../images/icons/mySuggestions.png')} />
                        </View>
                    ...
                    <View style={[styles.boxSize, styles.borderLeft, { backgroundColor: "white" }]} >
                        <View style={styles.imageIcon}>
                            <Image
                                resizeMode='cover'
                                style={{ height: 35, width: 35 }}
                                source={require('./../../../images/icons/benefits.png')} />
                        </View>
                        <View style={styles.textBlock}>
