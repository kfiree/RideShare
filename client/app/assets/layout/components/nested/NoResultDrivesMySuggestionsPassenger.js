...
const NoResultDrivesMySuggestionsPassenger = () => {
    const { userData, setUserData, loadingPopup, setLoadingPopup, isSignedIn, setIsSignedIn } = useContext(Context)
    const { sendNotificationToClient, noResultPopup, setNoResultPopup } = useContext(ContextOtherOffer)
...
export default NoResultDrivesMySuggestionsPassenger;
