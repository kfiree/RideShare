...
function CreateDrive() {
    const { userData, setUserData, pages, setPages, location, setLocation, listUniversities, setListUniversities, 
        checkCityForUniversity, cities, universities, loadingPopup, setLoadingPopup } = useContext(Context)
                    ...
                    <View style={styles.formBlock}>
                        <View style={styles.textAndInput}>
                            <View style={
                                ...
                                <TextInput placeholder="DD/MM/YYYY" value={'fdbdfbfdbfbdfbdfbd'} style={styles.inputText}
                            ...
                            <View style={styles.leftBlock}>
                                ...
                                <SelectDropdown
                                    ...
                                    onSelect={(selectedItem, index) => {
                                        citySrc ? setSrc(selectedItem) : setSrc(checkCityForUniversity(selectedItem))
