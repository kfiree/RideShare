...
const CreateDrivePopup = ({ showPopup, setShowPopup }) => {
            ...
            <View style={styles.container}>
                <View style={{ width: "100%", height: "100%", position: 'absolute', opacity: 0.5 }}>
                    <ImageBackground
                        ...
                        source={require('./../../../images/images/cover.jpeg')}>
                    </ImageBackground>
                </View>
                <View style={styles.popup}>
                    <View style={styles.rowBox}>
                        <Text style={styles.titlePopup}>הנסיעה</Text>
                    </View>
                    <View style={styles.rowBox}>
                        <Text style={styles.titlePopup}>נוספה בהצלחה!</Text>
                    </View>
