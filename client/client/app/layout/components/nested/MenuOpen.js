...
const MenuOpen = () => {
    const { userData, pages, setPages, setUserData, checkCityForUniversity, cities, universities, loadingPopup, setLoadingPopup } = useContext(Context)
...
const styles = StyleSheet.create({
    ...
    ProfileDetails: {
        width: "100%",
        height: 220,
        borderBottomColor: colors.switchSilver,
        borderBottomWidth: 2,
    },
    closeMenu: {
        width: "100%",
